...
| RHMZ RS | `051 315-538` (hidrologija), centrala `+387 51 433-522`, stavka „Захтјев за подацима" na `rhmzrs.com` | **da poprave dvije svoje stranice** — mapu automatskih stanica (`config` nedefinisan) i stranicu biltena (`#docs` element ne postoji). Ne tražimo novo, nego da proradi njihovo. `robots.txt` im dozvoljava sve. |
